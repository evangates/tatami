 ...
 * @author evan.gates
 */
public class Transform2DWrapping extends Component {
  public float minX;
  public float maxX;
  ...
  public Transform2DWrapping(float minX, float maxX, float minY, float maxY, float minRotationInDegrees, float maxRotationInDegrees) {
    this.minX = minX;
    this.maxX = maxX;
    this.minY = minY;
    this.maxY = maxY;
